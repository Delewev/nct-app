        ...
        <div class="row col-md-9 mx-auto rounded">
            <div class="col align-self-center">
                <div class="row ">
                    ...
                    <button type="button" class="col-md-6 btn btn-outline-danger mb-3" data-toggle="modal" data-target="#exampleModal">
                        Добавить
                    </button>
            ...
            <div class="col">
                <div class="ml-2">
                    <img class="img-fluid" src="../../../public/img/Login-foto.png" alt="" style="width: 500px" >
                </div>
            </div>
        </div>
