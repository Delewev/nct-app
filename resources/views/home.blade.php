                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="slider_text">
                            ...
                            <div class="sldier_btn wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".5s">
                                <a href="{{route('fest.index')}}" class="boxed-btn3">Заполнить</a>
                            </div>
                            <div style="margin-top: 20px">
                            <a href="#" ><p class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".4s">Участники</p></a>
                            </div>
                        </div>
                    </div>
                </div>
...
{{--                            <div class="thumb">--}}
{{--                                <img src="{{asset('img/Shet/img/svg_icon/1.svg')}}" alt="">--}}
{{--                            </div>--}}
...
{{--                        <div class="jobs_left d-flex align-items-center">--}}
{{--                            <div class="thumb">--}}
{{--                                <img src="{{asset('img/Shet/img/svg_icon/2.svg')}}" alt="">--}}
{{--                            </div>--}}
{{--                            <div class="jobs_conetent">--}}
...
{{--                        <div class="jobs_left d-flex align-items-center">--}}
{{--                            <div class="thumb">--}}
{{--                                <img src="{{asset('img/Shet/img/svg_icon/3.svg')}}" alt="">--}}
{{--                            </div>--}}
{{--                            <div class="jobs_conetent">--}}
